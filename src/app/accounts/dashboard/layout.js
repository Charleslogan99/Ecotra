...
const navigation = [
  ...
  { name: "Book a Tour", href: "/accounts/dashboard/bookings", icon: <FaCalendarCheck /> },
  { name: "Manage Bookings", href: "/accounts/dashboard/manage-bookings", icon: <FaClipboardList /> },
  { name: "Payment History", href: "/accounts/dashboard/payment-history", icon: <FaHistory /> },
];
      ...
      {!menuOpen && (
        <nav className="bg-white shadow-md px-6 flex items-center justify-between sticky top-0 z-[9999] w-full">
          ...
          <div className="flex items-center space-x-6">
            <FaBell className="text-gray-600 w-6 h-6 cursor-pointer hover:text-green-500" />
